-- ==========================================
-- Auto-initialization script for patient_db
-- Creates clinic tables and default clinic
-- ==========================================
...
INSERT INTO clinic_info (
    ...
    '07:00:00', '20:00:00',  -- Monday
    '07:00:00', '20:00:00',  -- Tuesday
    '07:00:00', '20:00:00',  -- Wednesday
    '07:00:00', '20:00:00',  -- Thursday
    '07:00:00', '20:00:00',  -- Friday
    '07:00:00', '20:00:00',  -- Saturday
    NULL, NULL               -- Sunday (closed)
);

-- ==========================================
-- Insert Default Clinic Services
-- ==========================================
INSERT INTO clinic_services (clinic_id, service_name, description, category, duration_minutes, price) VALUES
...
-- Verification
-- ==========================================
SELECT 'Clinic initialization complete!' AS status;
